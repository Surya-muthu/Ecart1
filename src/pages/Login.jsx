...
import { loginUser, restoreSession } from "../redux/Slice/authSlice";
...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setError(err?.detail || err || "Invalid email or password");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <style>{`
        ...
        .stage { position: relative; width: 100%; min-height: 90vh; display: flex; justify-content: center; align-items: center; perspective: 1500px; overflow: hidden; }
        ...
        .card-light { max-width: 900px; width: 90%; display: flex; border-radius: 2rem; background: #fff; box-shadow: 0 25px 60px rgba(0,0,0,0.08); overflow: hidden; transition: transform 0.5s ease, box-shadow 0.5s ease; position: relative; z-index: 1; min-height: 560px; }
        ...
        .signup-link { font-size: 0.8rem; text-align: center; margin-top: 1rem; color: #6366f1; cursor: pointer; }

        @media (max-width: 768px) { .card-light { flex-direction: column; min-height: auto; } .left-section, .right-section { flex: unset; padding: 2rem; } .left-section h1 { font-size: 2rem; } }
      `}</style>
      ...
      <div ref={stageRef} className="stage">
        ...
        <div className="card-light">
          <div className="left-section">
            ...
            <p>
              Login to your account and continue building your digital presence with our secure platform.
            </p>
          </div>
